...
const uniIdRouter = {};
const tabBar = {
  selectedColor: "#0b58f4",
  backgroundColor: "#f3f4f6",
  borderStyle: "white",
  list: [
    {
      text: "\u7B14\u8BB0",
      iconPath: "static/\u7B14\u8BB0_hover (1).png",
      selectedIconPath: "static/\u7B14\u8BB0_hover.png",
      pagePath: "pages/index/index"
    },
    {
      text: "\u6211",
      iconPath: "static/\u6211\u7684-\u6211\u7684 (1).png",
      selectedIconPath: "static/\u6211\u7684-\u6211\u7684.png",
...
let m;
m = g;
const y = f('{\n    "address": [\n        "127.0.0.1",\n        "192.168.61.1",\n        "192.168.111.1",\n        "10.100.32.63"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), _ = f('[{"provider":"aliyun","spaceName":"chen","spaceId":"b1585a67-b047-4523-890f-559447906a03","clientSecret":"2cuPVphMMC9PZjDhtS85SQ==","endpoint":"https://api.bspapp.com"}]') || [];
let v = "";
try {
  v = "__UNI__B971A11";
} catch (e2) {
